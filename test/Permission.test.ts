...
describe('NftSwap', function () {
  ...
  it('Should not allow non-participants to agree to a trade');
  it('Should not allow non-participants to confirm a trade');
  it('Should not allow non-participants to cancel a trade');
});
